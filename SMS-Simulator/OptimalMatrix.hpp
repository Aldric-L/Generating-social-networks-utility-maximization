...
class OptimalMatrix {
    ...
    akml::DynamicMatrix<float> buildGlobalGradient(akml::Matrix<float, GRAPH_SIZE, GRAPH_SIZE> adjacencyMatrix, const akml::Matrix<Individual*, GRAPH_SIZE, 1>& individuals);
...
public:
    akml::Matrix<float, GRAPH_SIZE, GRAPH_SIZE> compute(akml::Matrix<float, GRAPH_SIZE, GRAPH_SIZE> adjacencyMatrix, const akml::Matrix<Individual*, GRAPH_SIZE, 1>& individuals);
